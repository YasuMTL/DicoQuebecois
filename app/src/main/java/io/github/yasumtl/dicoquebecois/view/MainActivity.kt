...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val viewModel: ExpressionListViewModel =
            ViewModelProvider(this).get(ExpressionListViewModel::class.java)
        val expresQC = ArrayList<String>()
        val expressionQcFr = HashMap<String, String>()
        ...
        viewModel.expressionListLiveData.observe(this, { newExpression ->
            ...
            if (newExpression != null) {
                for (oneEntry in newExpression.feed.entry) {
                    ...
                    expresQC.add(phraseQC)
                    expressionQcFr[phraseQC] = oneEntry.expressionFR.phraseFR
                }
        ...
        listView.onItemClickListener =
            AdapterView.OnItemClickListener { parent, view, position, id ->
                ...
                val meaning = expressionQcFr[itemText]
